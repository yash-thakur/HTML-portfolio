...
<div class="row flex-xl-nowrap mx-0">
	...
	<main class="col-12 col-lg-9 col-xl-10 p-0">
		...
		<div id="home" class="home banner-section">
			<div class="bg-img" style="background-image: url('../../../images/bg.jpg');">
				<div class="content">
					...
					<button class="btn btn-primary text-uppercase px-4 mt-3">Download my cv</button>
				</div>
		...
		<div id="about" class="about py-md-5 px-xl-5 px-md-3 p-3">
			<div class="row mx-0">
				<div class="col-xl-4 col-lg-6 col-md-4 py-2">
					...
					<div class="about-social bg-primary text-center p-3 text-center">
				...
				<div class="col-xl-8 col-lg-6 col-md-8 py-2">
					...
					<div class="row mx-0 my-4">
						<div class="col-xl-4 col-lg-6 col-sm-6 px-md-0 py-3">
							...
							<div class="d-inline-block align-top">
								<h5 class="font-weight-medium">Name:</h5>
						...
						<div class="col-xl-4 col-lg-6 col-sm-6 px-md-0 py-3">
							...
							<div class="d-inline-block align-top">
								<h5 class="font-weight-medium">Phone:</h5>
						...
						<div class="col-xl-4 col-lg-6 col-sm-6 px-md-0 py-3">
							...
							<div class="d-inline-block align-top">
								<h5 class="font-weight-medium">Date Of Birth:</h5>
								<p class="text-gray-light font-weight-medium">
									25 September
						...
						<div class="col-xl-4 col-lg-6 col-sm-6 px-md-0 py-3">
							...
							<div class="d-inline-block align-top">
								<h5 class="font-weight-medium">Address:</h5>
								<p class="text-gray-light font-weight-medium">
									24 SL Road,
									<span class="d-block">London. UK</span>
								</p>
							</div>
						</div>
						<div class="col-xl-4 col-lg-6 col-sm-6 px-md-0 py-3">
							...
							<div class="d-inline-block align-top">
								<h5 class="font-weight-medium">Nationality:</h5>
								<p class="text-gray-light font-weight-medium">
									United Kingdom
								</p>
							</div>
					...
					<div class="desc">
						<p class="font-italic text-gray-light">I have more than <span class="text-dark font-weight-medium">9 years of experience</span> in the field of Graphic/ E Learning/Web Designing. Specialized in Adobe web & graphic designing tools and also in otheta tools. Professional in Corporate branding, Graphic designing, <span class="text-dark font-weight-medium">Web Designing,</span> visualization, GUI, graphics & animations for e-learning, illustrations, web icons, flash web banner, flash intro animations, logos, brochures, posters etc.</p>
						<p class="font-italic text-gray-light">Creative Solution Provider as a Freelance Graphic Artist and a Dedicated, Team worker to Induce the Creative Juice among the colleagues with a View to deliver the Best and New in the business.</p>
						<div class="text-right py-3">
							<img src="../../../images/signature.png" class="mw-100" />
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-xl-3 col-lg-6 col-sm-6 py-2">
					<div class="service-block">
						...
						<div class="contact-btn">
							<a href="#" class="clearfix btn btn-primary btn-block rounded-0 py-0">
					...
					<div class="col-md-6 py-2">
						<ul class="list-unstyled mb-3 d-inline-block w-100">
							...
							<li class="mb-3">
								...
								<div class="progress-bar d-inline-block w-100 mb-0">
									<p class="bar bg-primary float-left py-2 mb-0" style="width: 55%;">
							...
							<li class="mb-3">
								...
								<div class="progress-bar d-inline-block w-100 mb-0">
									<p class="bar bg-primary float-left py-2 mb-0" style="width: 80%;">
							...
							<li class="mb-3">
								...
								<div class="progress-bar d-inline-block w-100 mb-0">
									<p class="bar bg-primary float-left py-2 mb-0" style="width: 65%;">
								...
								<div class="item">
									<div class="item-hover">
										...
										<div class="item-info">
											...
											<span class="text-primary d-block">by Sam Martin</span>
											<div class="item-link">
		...
		<div id="testimonials" class="testimonials py-md-5 px-xl-5 px-md-3 p-3">
			...
			<div class="row mx-0 my-4">
				<div class="col-xl-4 col-lg-4 col-md-4 py-2">
					<div class="testimonials-block">
						<div class="testimonials-content rounded p-3 d-table">
		...
		<div id="contact" class="contact">
			<div class="contact-info">
				...
				<div class="contact-details p-4 text-white">
					<h2 class="font-weight-normal my-4">Say Hi It’s Free!</h2>
					<div class="address pt-4">
						<ul class="list-unstyled">
							<li class="d-table mb-4">
								<span class="icon d-table-cell ti-location-pin"></span>
								<p class="d-table-cell pl-3">Valsad, Gujarat, India.</p>
							</li>
							<li class="d-table mb-4">
								<span class="icon d-table-cell ti-marker-alt"></span>
								<p class="d-table-cell pl-3">
									<a href="mailto:mail@yashthakur.in" class="email">mail@yashthakur.in</a>
								</p>
							</li>
							<li class="d-table mb-4">
								<span class="icon d-table-cell ti-mobile"></span>
								<p class="d-table-cell pl-3">
									<a href="tel:+91-8866991944" class="ph-no">+91-8866991944</a>
								</p>
							</li>
						</ul>
					</div>
					<div class="social pt-4">
						<h5 class="font-weight-normal text-uppercase">I'm also on Social Networks</h5>
						<p class="info-text">Follow me on social networks to get the latest news, blog, updates and much more.</p>
						<ul class="list-unstyled text-center pt-4">
							<li class="d-inline-block align-top">
								<a href="#" class="social-icon px-2"><i class="fa fa-facebook"></i></a>
							</li>
							<li class="d-inline-block align-top">
								<a href="#" class="social-icon px-2"><i class="fa fa-twitter"></i></a>
							</li>
							<li class="d-inline-block align-top">
								<a href="#" class="social-icon px-2"><i class="fa fa-dribbble"></i></a>
							</li>
							<li class="d-inline-block align-top">
								<a href="#" class="social-icon px-2"><i class="fa fa-vimeo"></i></a>
							</li>
							<li class="d-inline-block align-top">
								<a href="#" class="social-icon px-2"><i class="fa fa-pinterest-p"></i></a>
							</li>
							<li class="d-inline-block align-top">
								<a href="#" class="social-icon px-2"><i class="fa fa-behance"></i></a>
							</li>
							<li class="d-inline-block align-top">
					...
					<div class="text-center pt-4">
						<a class="btn btn-primary py-3 px-4 text-uppercase" href="http://yashthakur.in/wp-content/uploads/2017/01/Resume.pdf">Download my CV</a>
					</div>
				</div>
			</div>
		</div>
